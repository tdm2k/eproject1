...
<head>
    ...
    <title>Space Dot Com | Change Password</title>
...
<body>
    ...
    <div class="container request-container">
        <div class="request-form-wrapper">
            ...
            <form action="../../controllers/UserController.php?action=user_change_password" method="post">
                <input type="hidden" name="id" value="<?= $_SESSION['user_id'] ?>" required>
                <div class="mb-3">
