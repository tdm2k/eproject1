...
<div class="main-page-content d-flex flex-column min-vh-100">
    ...
    <main class="flex-grow-1 p-4">
        ...
        <?php if ($action === 'add' || $action === 'edit'): ?>
            <a href="AdminArticle.php" class="btn btn-secondary mb-3">
        ...
        <?php else: ?>
            <a href="AdminArticle.php?action=add" class="btn btn-primary mb-3">
            ...
            <table class="table table-bordered table-hover">
                ...
                <?php foreach ($articles as $article): ?>
                    <tr>
                        ...
                        <td>
                            <a href="AdminArticle.php?action=edit&id=<?= $article['id'] ?>" class="btn btn-sm btn-warning">
                                <i class="bi bi-pencil-square"></i> Sửa
                            </a>
                            <a href="AdminArticle.php?action=delete&id=<?= $article['id'] ?>"
